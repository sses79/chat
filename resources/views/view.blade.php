...
<head>
    ...
    <link href="{{ url('view/css/freeboard.min.css') }}" rel="stylesheet" />
    <script src="{{ url('view/js/freeboard.thirdparty.min.js')}}"></script>
    <script type="text/javascript">
        head.js("{{ url('view/js/freeboard_plugins.min.js')}}",
            // *** Load more plugins here ***
            function(){
                $(function()
                { //DOM Ready
                    freeboard.initialize(false);
                    freeboard.loadDashboard({!! Auth::user()->dashboard !!}, function (){
...
<header id="main-header" data-bind="if:allow_edit">
    <div id="admin-bar">
        <div id="admin-menu">
            <div id="board-tools">
                <h1 id="board-logo" class="title bordered">Dashboard</h1>
